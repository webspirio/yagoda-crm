...
describe('прив’язка виплати до візиту', () => {
  beforeEach(() => {
    ...
    // ЧОМУ ТУТ ПОПОВНЕННЯ КАСИ. Ці тести про звʼязок виплати з візитом, а не про готівку.
    // Після підключення `G12`/`I58` (виплата впирається в касу за ЯГОДУ) на Шипинках
    // 04.08 у книзі лишається 1 616,10 ₴ — стільки й було задумано в §8.4, — і другий же
