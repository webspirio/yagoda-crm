...
describe('канонічний журнал ящиків — звірка зі спекою 21 §8.2', () => {
  ...
  it('9 600,00 ₴ — це РІВНО та сума, що губиться в її аркуші через назву села в грошовій клітинці', () => {
    expect(33_000 - 23_400).toBe(9_600)
    expect(80 * PRICE).toBe(9_600)
  })

  it('аркуш стверджує 33 000,00 ₴ — це 275 × 120, тобто ВСЕ видане, без жодного повернення', () => {
    expect(275 * PRICE).toBe(33_000)
  })
